...
if __name__ == "__main__":
    ...
    low = float(input("Min interval between clicks (seconds): "))
    high = float(input("Max interval between clicks (seconds): "))
    random_clicker(target_x, target_y, interval_range=(low, high))
